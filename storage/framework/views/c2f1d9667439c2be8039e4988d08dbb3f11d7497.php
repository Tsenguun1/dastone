    ...
    <div class="modal-dialog" role="document" style="max-width: 900px;">
        <div class="modal-content">
            <div class="form-container" id="formContainer">
                ...
                <?php endif; ?>
                <div class="container mt-5">
                    <form id="addEmployeeForm" method="POST" action="<?php echo e(route('addemployee')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label" for="last_name">Эцэг/эхийн нэр:</label>
...
<?php /**PATH C:\Users\pc\Documents\GitHub\dastoneTest\dastone\resources\views/modal/addemployee.blade.php ENDPATH**/ ?>
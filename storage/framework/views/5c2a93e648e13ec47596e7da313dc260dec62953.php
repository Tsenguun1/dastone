        ...
        <div class="modal-content">
            <div class="form-container" id="formContainer">
                <form id="registrationForm" method="POST" action="<?php echo e(route('addform')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <label for="depName" class="form-label">Газар нэгжийн нэршил</label>
                    ...
                    <div class="mb-3">
                        <label for="sortOrder" class="form-label">Эрэмбэ</label>
                        <input type="number" class="form-control" id="sortOrder" name="sortOrder" required>
                    </div>
                    <div class="mb-3">
                        <label for="parentDepId" class="form-label">Эцэг газар нэгж</label>
                        <select id="parentDepId" name="parentDepId" class="form-select" required>
                            <option value="">[Сонгоно уу]</option>
                    ...
                    <div class="mb-3">
                        <label for="directorEmpId" class="form-label">Захирал</label>
                        <select id="directorEmpId" name="directorEmpId" class="form-select" required>
                            <option value="">[Сонгоно уу]</option>
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($employee->EMP_ID); ?>"><?php echo e($employee->EMPNAME); ?> (<?php echo e($employee->DEP_NAME); ?>-<?php echo e($employee->POS_NAME); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
